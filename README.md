...
```shell
  docker buildx build -t scraly/ovhimages-extension:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install scraly/ovhimages-extension:latest
```
...
```shell
docker extension update scraly/ovhimages-extension:latest
```
